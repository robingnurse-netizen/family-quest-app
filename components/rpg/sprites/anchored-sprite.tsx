 ...
 * still lines up. `mirror` flips it horizontally around its feet. CSS
 * effects that move the whole sprite (slides, shakes) go on the wrapper
 * (`className`); body motion like a leap animates `bodyRef`.
 */
export function AnchoredSprite({
  ...
  paused?: boolean;
  onComplete?: () => void;
  /** The sprite itself: for body motion like a leap. */
